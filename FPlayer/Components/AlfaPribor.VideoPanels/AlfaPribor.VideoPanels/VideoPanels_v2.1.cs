...
namespace AlfaPribor.VideoPanels
{
    ...
    public class VideoPanels_v2
    {
        ...
        public VideoPanels_v2(VideoStyle style, Control Owner, double SplitterSize,
        ...
        public VideoPanels_v2(VideoStyle style, Control Owner,
        ...
        public VideoPanels_v2(VideoStyle style, Control Owner, double SplitterSize, bool HiddenCaptions,
        ...
        void SetTripleWindows()
        {
            ...
            tspFirst.Controls.Add(p);
            tspFirst.SetRow(p, 2);
            tspFirst.SetColumn(p, 0);
            tspFirst.SetColumnSpan(p, 1);
            */     

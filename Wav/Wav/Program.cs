...
namespace WavFormatCSharp
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n\nAudioFormat {0}", header.AudioFormat);
            Console.WriteLine("BlockAlign {0}", header.BlockAlign);
            Console.WriteLine("ByteRate {0}", header.ByteRate);
            Console.WriteLine("ChunkId {0}", header.ChunkId);
            Console.WriteLine("ChunkSize {0}", header.ChunkSize);
            Console.WriteLine("Format {0}", header.Format);
            Console.WriteLine("NumChannels {0}", header.NumChannels);
            Console.WriteLine("SampleRate {0}", header.SampleRate);
            Console.WriteLine("Subchunk1Id {0}", header.Subchunk1Id);
            Console.WriteLine("Subchunk1Size {0}", header.Subchunk1Size);
            Console.WriteLine("Subchunk2Id {0}", header.Subchunk2Id);
            Console.WriteLine("Subchunk2Size {0}", header.Subchunk2Size);

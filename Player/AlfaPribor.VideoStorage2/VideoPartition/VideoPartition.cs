    ...
    public class VideoPartition
    {
        ...
        public static VideoPartitionSettings GetSettings(VideoPartition partition)
        {
            ...
            VideoPartitionSettings settings = new VideoPartitionSettings(
                partition.Id, partition.Active, partition.Path, partition.FreeSpaceLimit
            );
            return settings;
        }
        ...
        public VideoPartitionState Status
        {
            get
            {
                ...
                if (_Active)
                {
                    if (Directory.Exists(_Path))status = VideoPartitionState.Ok;
                    else status = VideoPartitionState.Fault;
                }
                else status = VideoPartitionState.Inactive;
